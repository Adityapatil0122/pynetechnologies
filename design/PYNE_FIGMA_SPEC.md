...
- Desktop Home: 1440px wide, light background, sticky header, animated hero with Launch Cockpit, stats strip, services, automation, process, clients marquee, blog preview, contact CTA.
...
- Automation Detail: light lime intro, capability panel, practical workflow CTA.
...
- Automation tile: icon, title, short description.
